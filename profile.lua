...
<svg width="$widthpx" height="$heightpx" version="1.1" xmlns="http://www.w3.org/2000/svg">
	...
	<defs>
	  <style type="text/css">
		<![CDATA[
		  ...
		  rect.main  { fill: rgb(150,150,150); fill-opacity: 0.5; }
		  rect.c     { fill: rgb(200,150,150); fill-opacity: 0.5; }
		  rect.extern{ fill: rgb(150,150,200); }
	...
	<rect class="main" x="350px" y="10px" width="$barheight" height="10px"/>
	<text transform="translate(%d,%d) rotate(0)" class="main" x="405px" y="19px">Main</text>
	
	<rect class="main extern" x="350px" y="20px" width="$barheight" height="10px"/>
	<text transform="translate(%d,%d) rotate(0)" class="main" x="405px" y="29px">Extern</text>
	...
	elseif line == "SECT_END" then
		...
		elseif why == "-" then
			...
			local function finalize_info(info)
				...
				local class = is_c and "c" or "main"
